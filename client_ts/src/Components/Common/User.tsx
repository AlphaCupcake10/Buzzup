...
type DataInput = {name:string | undefined,username:string | undefined} | undefined | null;
type UserProps = {data?:DataInput,className?:string,children?:React.ReactNode,small?:boolean};
